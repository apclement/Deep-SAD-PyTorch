...
class MyADDataset(BaseADDataset):
    ...
    def __init__(self, root):
       ...
       # Get train set
        self.train_set = S3_CSV(f's3://ml4ra/_vat_training/sagemaker/vat/train_deep.csv/', shuffle_urls=True)       
    
        # Get test set
        self.test_set = S3_CSV(f's3://ml4ra/_vat_training/sagemaker/vat/test_deep.csv/', shuffle_urls=False)
